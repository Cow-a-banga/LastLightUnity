...
float4 MyFragmentProgram (Interpolators i) : SV_TARGET {
    ...
    fixed4 albedo = splatControl.r * tex2D (_Splat0, i.uv * _Splat0_ST.xy);
    albedo += splatControl.g * tex2D(_Splat1, i.uv * _Splat1_ST.xy);
    albedo += splatControl.b * tex2D (_Splat2, i.uv * _Splat2_ST.xy);
    albedo += splatControl.a * tex2D (_Splat3, i.uv * _Splat3_ST.xy);
    ...
    float3 celShadedDiffuse = albedo.rgb * light.color * NdotL;
