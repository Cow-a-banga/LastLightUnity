Shader "Roystan/Toon Complete"
{
    Properties
    {
        ...
        [HDR]
        _OutlineColor("Outline Color", Color) = (1, 0, 0, 1) // Цвет обводки изменен на красный
        _OutlineThickness("Outline Thickness", Float) = 100 // Значение увеличено для видимости
    }
    SubShader
    {
        Pass
        ...
        Pass
        {
            ...
            {
                // Vertex displacement for the outline
                v2f o;
